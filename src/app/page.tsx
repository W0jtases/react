...
export default function Home() {
  return (
    <div className="w-full h-screen flex flex-col justify-between bg-[#333333]">
      <Head>
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&display=swap" />
      </Head>
      <nav id='custom-bg' className="custom-bg w-full max-w-screen-lg mx-auto rounded-b-4xl font-monospace p-2 fixed top-0 left-1/2 transform -translate-x-1/2 flex items-center gap-2 text-white bg-[#2c2c2c] backdrop-opacity-70 z-50">
      ...
      <main id='home' className="w-full custom-bg flex flex-col items-center justify-center">
          ...
          <div className="w-full h-48 flex items-center">
            <div  className="h-full w-6/10 flex items-end justify-center">
              <Fade direction="down" triggerOnce>
                <h1 className="text-white text-5xl font-bold sm:text-7xl md:text-8xl text-center font-serif">Front-end</h1>
              </Fade>
            </div>
            <div className="h-full w-4/10 flex items-center justify-center">
              <Fade direction="right" triggerOnce delay={900}>
                <a href="#projects"><button className="text-black bg-white px-15 py-3 md:px-20 md:py-4 rounded-4xl mr-8 hover:cursor-pointer">Projects</button></a>
              </Fade>
            </div>
          </div>
          <div className="w-full h-48 flex items-center">
            <div className="h-full w-4/10 flex items-center justify-center">
              <Fade direction="left" triggerOnce delay={600}>
                <p className="text-white w-64 ml-30 font-serif">My goal is to write maintainable, clean and understandable code to process development was enjoyable.</p>
              </Fade>
            </div>
            <div className="h-full w-6/10 flex items-start justify-center">
              <Fade direction="up" triggerOnce delay={300}>
                <h1 className="text-white text-5xl sm:text-7xl md:text-8xl font-bold text-center font-serif">Developer</h1>
              </Fade>
            </div>
        ...
        <div id="about" className="w-full max-w-screen-lg min-h-screen flex flex-col items-center justify-center">
          <div className="w-full h-48 flex items-center">
            ...
            <Fade direction='up' triggerOnce>
              <h1 className="text-white text-5xl sm:text-7xl md:text-8xl text-center font-mono">About me</h1>
            </Fade>
            </div>
          </div>
          ...
          <Fade direction='up' delay={200} triggerOnce>
              <p className="text-white md:text-xl sm:text-base text-sm w-full font-mono">I have been formally learning programming since 2022, focusing on the latest technologies and trends in the field. My goal is to stay up-to-date with emerging tools and languages, and to continuously improve my skills in order to build innovative and efficient solutions.
              </p>
            </Fade>
          </div>
        ...
        <Fade className='w-2/4 h-full flex align-center gap-1 ' direction='up' delay={800} triggerOnce>
        ...
        <div id="projects" className="w-full max-w-screen-lg min-h-screen flex flex-col items-center justify-center">
          <div className="w-full h-48 flex items-center">
            <div className="h-full w-full flex items-center justify-center">
              <h1 className="text-white text-5xl sm:text-7xl md:text-8xl text-center font-serif">Projects</h1>
            </div>
          </div>
          <div className="w-full h-128 flex items-center">
        ...
        <div className='w-3/4 rounded-3xl h-2/6 bg-[#3b3b3b] flex justfy-center flex-col'>
          <div className='w-full h-1/5 flex items-center justfy-center'>
            ...
            <a target='_blank' href="https://w0jtases.github.io/pokemon/"><button className='bg-white w-30 h-10 rounded-full flex flex-row gap-4 text-xl font-bold items-center justify-center hover:cursor-pointer'>Test <img className='h-5' src="play.svg" />
            </button></a>
                  <a target='_blank' href="https://github.com/W0jtases/pokemon"><button className='bg-white w-30 h-10 rounded-full flex flex-row gap-4 text-xl font-bold items-center justify-center hover:cursor-pointer'>Code <img className='h-5' src="link.svg" />
                  </button></a>
            </div>
        </div>
              </div>
        ...
        <div id="contact" className="w-full h-32 flex items-center">
          ...
          <a target='_blank' className='h-8 flex justify-center items-center' href="https://github.com/W0jtases">
            <p className='text-white mr-2 font-bold'>W0jtases</p>
            <img src="github.svg" className='h-full' />
          </a>
          <a target='_blank' className='h-8 flex justify-center items-center' href="mailto:wjtases@gmail.com">
